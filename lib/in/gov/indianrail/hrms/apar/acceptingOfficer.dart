...
import 'package:hrms_cris/in/gov/indianrail/hrms/apar/gazettedoffierviewModel.dart';
import 'package:hrms_cris/in/gov/indianrail/hrms/local_shared_pref/sharedpreferencemanager.dart';

late int listSize;

class AcceptingOfficer extends StatefulWidget {
  final List<GazettedOfficerModel> userList;
  final String title;
  final int arraySize;

  AcceptingOfficer(this.userList, this.title, this.arraySize);

  @override
  _AcceptingOfficerState createState() => _AcceptingOfficerState();
}

class _AcceptingOfficerState extends State<AcceptingOfficer> {
  final sharedpreferencemanager pref = sharedpreferencemanager();

  @override
  Widget build(BuildContext context) {
    listSize = widget.arraySize;
